...
📄 **Full paper:** [docs/Energy_last_to_fail.pdf](docs/Energy_last_to_fail.pdf) — pre-print DOI [10.5281/zenodo.22737055](https://doi.org/10.5281/zenodo.22737055)
...
https://doi.org/10.5281/zenodo.22737055.

This package: A. Chancé, *SQD_energy_last_to_fail: replication package*, version 1.3.0, Zenodo (2026),
https://doi.org/10.5281/zenodo.22735428. `CITATION.cff` carries both.
