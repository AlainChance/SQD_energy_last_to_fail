...
\begin{table}[htbp]
\centering
\caption{Exact samples of two states in the (10e, 12o) window of N$_2$ at 1.0975 \AA{}, 50 000 shots each, and the static loop on them; full CI $-$108.999490 Ha, Hartree--Fock $-$108.867774 Ha.}\label{tab:10}
\small
\renewcommand{\arraystretch}{1.3}
\begin{tabularx}{\linewidth}{@{}>{\hsize=1.088\hsize\raggedright\arraybackslash}Xlll>{\hsize=0.912\hsize\raggedright\arraybackslash}X@{}}
\toprule
